  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800 overflow-x-hidden select-none">
      ...
      <header className="w-full top-0 sticky border-b border-slate-200 bg-white z-50 shadow-sm">
        <div className="flex justify-center items-center py-4 w-full max-w-7xl mx-auto">
          <h2 className="text-xl md:text-2xl font-semibold text-blue-600 text-center">
      ...
      <main className="flex-grow flex flex-col items-center justify-center relative px-6 py-12 z-10">
        ...
        <div className="w-full max-w-3xl text-center space-y-12">
          <div className="space-y-4">
            ...
            <p className={`${currentFontSize.body} max-w-xl mx-auto text-slate-600`}>
              Please use this kiosk to begin your check-in process.
            </p>
          </div>
